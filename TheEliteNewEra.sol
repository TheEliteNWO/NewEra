...
Welcome to The Elite: New Era, an organization of people whose main goal is to disrupt the cryptocurrency scene, one coin at a time. 
...
contract TheEliteNewEra is ERC20, Ownable{
    ...
    address public marketingWallet = 0x900cda50CEbEFaC173Afa1b2Ae84344Af5be65c5;
    address public devWallet = 0xC1f0389Ee21F6d899f1f7f5B5ef995F40098B62a;
    ...
    Taxes public taxes = Taxes(7,2,3);
    Taxes public sellTaxes = Taxes(7,2,3);
    ...
    constructor() ERC20("The Elite: New Era", "NWO") {
